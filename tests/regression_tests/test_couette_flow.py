...
class TestCouetteFlowQR(CouetteFlow):
    name = "Couette flow k2=0 k3=1 QR"
...
class TestCouetteFlowQZ(CouetteFlow):
    name = "Couette flow k2=0 k3=1 QZ"
    filename = "couette_QZ_k2_0_k3_1"
    use_custom_baseline = "couette_QR_k2_0_k3_1"
...
class TestCouetteFlowQRCholesky(CouetteFlow):
    name = "Couette flow k2=0 k3=1 QR Cholesky"
    filename = "couette_QR_Cholesky_k2_0_k3_1"
    use_custom_baseline = "couette_QR_k2_0_k3_1"
