...
\begin{equation}
	\begin{aligned}
		...
		\omega \rho_0 T_1 &= -i\rho_0v_1T_0' +\rho_0\left(\frac{1}{r}k_2v_{02} + k_3v_{03}\right)T_1 - i(\gamma - 1)\rho_0T_0\left[\frac{1}{r}(rv_1)' + \frac{1}{r}ik_2v_2 + ik_3v_3\right]												\\
						  ...
						  &~~~~ + i(\gamma - 1)(\kappa_\bot - \kappa_\parallel)\frac{1}{B^2}T_0'\left[(B_{03}k_3^2 + \frac{1}{r}B_{02}k_2k_3)a_2 - \frac{1}{r}(B_{02}k_2^2\frac{1}{r} + B_{03}k_2k_3)a_3\right]													\\
...
\begin{align*}
	...
	\omega \rho_0 \frac{T_1}{\eps}	&= -\frac{1}{\eps}\rho_0T_0'v_1 + \frac{1}{\eps}\rho_0\left(\frac{k_2}{\eps}v_{02} + k_3v_{03}\right)T_1 - (\gamma - 1)\frac{1}{\eps}\rho_0T_0\left(v_1' - k_2v_2 - k_3v_3\right) 	\\
									...
									&~~~~ + i(\gamma - 1)\frac{(\kappa_\parallel - \kappa_\bot)}{\eps}\frac{1}{B^2}T_0'\left[\left(k_2k_3B_{02}\frac{1}{\eps} + k_3^2B_{03}\right)a_2 - \left(k_2^2B_{02}\frac{1}{\eps} + k_2k_3B_{03}\right)a_3\right]	\\
...
\begin{align*}
	...
	A_{jk}(5, 7) &=  \left[2i(\gamma-1)\frac{1}{\eps}\left(T_0'B_{03}\frac{\partial\kappa_\bot}{\partial(B^2)} + \eta B_{03}'\right)\right] h_j^5 \frac{dh_k^7}{dr}																						\\
				 &+  \int\left[i(\gamma-1)\frac{1}{\eps}\left\{(\kappa_\parallel - \kappa_\bot)\frac{T_0'}{B^2}(k_2k_3B_{02}\frac{1}{\eps} + k_3^2B_{03}) - 2\eta k_3^2 B_{03}' - 2\eta k_2k_3\frac{(\eps B_{02})'}{\eps^2}\right\}\right] h_j^5 h_k^7 dr				\\
	...
	A_{jk}(5, 8) &=  -\left[2i(\gamma-1)\left\{T_0' B_{02}\frac{\partial\kappa_\bot}{\partial(B^2)} + \eta\frac{(\eps B_{02})'}{\eps}\right\}\right] h_j^5 \frac{dh_k^8}{dr}																			\\
				 &-  \int\left[i(\gamma-1)\frac{1}{\eps}\left\{(\kappa_\parallel - \kappa_\bot)\frac{T_0'}{B^2}(k_2^2 B_{02}\frac{1}{\eps} + k_2k_3B_{03}) - 2\eta k_2k_3B_{03}' - 2\eta k_2^2\frac{(\eps B_{02})'}{\eps^2}\right\}\right] h_j^5 h_k^8 dr				\\
