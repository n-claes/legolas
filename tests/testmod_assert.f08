...
contains
  ...
  !! @param[out] bool   True if int1 = int2, false otherwise
  ...
  !! @param[out] bool     True if dble1 = dble2, false otherwise
  ...
  !! @param[out] bool   True if z1 = z2, false otherwise
  ...
  !! @param[in]  z1   First double precision complex
  !! @param[in]  z2   Second double precision complex
  !! @param[out] bool True if z1 < z2 (both real and imaginary parts),
  !!                  false otherwise
  ...
  !! @param[out] bool   True if dble1 is finite, false if dlbe1 = inf
  ...
  !! @param[out] bool  True if z1 is finite, false if z1 = inf
  ...
  !! @param[out] bool   True if dble1 is a number, false if dble1 = NaN
  subroutine assert_real_is_no_nan(dble1, bool)
    real(real64), intent(in)  :: dble1
    logical, intent(out)      :: bool

    bool = .not. ieee_is_nan(dble1)
  ...
  !! @param[in]  z1    Double precision complex to check
  !! @param[out] bool  True if z1 is a number, false if z1 = NaN
  subroutine assert_complex_is_no_nan(z1, bool)
    complex(real64), intent(in) :: z1
    logical, intent(out)        :: bool
