module mod_derived_ef_names
  ...
  character(len=str_len_arr), parameter :: S_name = "S"
  character(len=str_len_arr), parameter :: div_v_name = "div v"
  character(len=str_len_arr), parameter :: curl_v_1_name = "(curl v)1"
  character(len=str_len_arr), parameter :: curl_v_2_name = "(curl v)2"
  character(len=str_len_arr), parameter :: curl_v_3_name = "(curl v)3"
  character(len=str_len_arr), parameter :: B1_name = "B1"
  character(len=str_len_arr), parameter :: B2_name = "B2"
  character(len=str_len_arr), parameter :: B3_name = "B3"
  character(len=str_len_arr), parameter :: div_B_name = "div B"
  character(len=str_len_arr), parameter :: curl_B_1_name = "(curl B)1"
  character(len=str_len_arr), parameter :: curl_B_2_name = "(curl B)2"
  character(len=str_len_arr), parameter :: curl_B_3_name = "(curl B)3"
  character(len=str_len_arr), parameter :: B_para_name = "B_para"
  character(len=str_len_arr), parameter :: B_perp_name = "B_perp"
  character(len=str_len_arr), parameter :: curl_B_para_name = "(curl B)_para"
  character(len=str_len_arr), parameter :: curl_B_perp_name = "(curl B)_perp"
  character(len=str_len_arr), parameter :: v_para_name = "v_para"
  character(len=str_len_arr), parameter :: v_perp_name = "v_perp"
  character(len=str_len_arr), parameter :: curl_v_para_name = "(curl v)_para"
  character(len=str_len_arr), parameter :: curl_v_perp_name = "(curl v)_perp"
