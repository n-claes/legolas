...
contains
  ...
  module procedure set_pp_quantities
    call set_magnetic_field_pp(loc=locB, ef_index=ef_index)
    call set_magnetic_field_curl_pp(loc=locCurlB, ef_index=ef_index)
    call set_velocity_pp(loc=locV, ef_index=ef_index)
    call set_velocity_curl_pp(loc=locCurlV, ef_index=ef_index)
