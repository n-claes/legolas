...
!! From Advanced Magnetohydrodynamics by Goedbloed, Keppens and Poedts, page 17 (sec. 13.2).
...
contains 
  ...
  module subroutine flow_driven_instabilities_eq()
    ...
    do i = 1, gauss_gridpts
      ...
      ! TODO: Aren't 2nd derivatives of B only for resistive terms?
      ! Then why are they defined here?
      eta_field % dd_B02_dr(i) = -B0 * sin(phi_x(i)) * alpha**2
      eta_field % dd_B03_dr(i) = -B0 * cos(phi_x(i)) * alpha**2
    end do
